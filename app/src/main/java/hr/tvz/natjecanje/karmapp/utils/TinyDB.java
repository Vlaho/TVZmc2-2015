/*
 * Modified by Tomislav Blažeka on 29.03.2015
 *
...
public class TinyDB {
    ...
    public Bitmap getImage(String path) {
        ...
        try {
            ...
            Utils.showAndLogError(mContext, TAG, e.getMessage());
            e.printStackTrace();
        }
    ...
    private String setupFolderPath(String imageName) {
        ...
        if (!mFolder.exists()) {
            if (!mFolder.mkdirs()) {
                Utils.showAndLogError(mContext, TAG, "Default Save Path Creation Error");
